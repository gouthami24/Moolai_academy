...
export class FaqComponent {
  faqs = [
    ...
    { question: 'How can I contact the academy for more information?', answer: 'You can reach us via email at ak@trymool.ai or through our contact form on the website. We are here to assist you with any questions or concerns you may have.' },
